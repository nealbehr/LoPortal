(function(settings){
    ...
    var app = angular.module('loApp', ['ngRoute', 'helperService', 'dashboardModule', 'authModule', 'ngCookies', 'requestModule', 'userModule', 'userProfileModule', 'adminModule', 'lenderModule', 'realtyCompanyModule', 'ngDialog', 'requestFlyerModule', 'approvalModule', 'vsGoogleAutocomplete']);
