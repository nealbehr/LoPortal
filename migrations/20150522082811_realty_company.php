...
class RealtyCompany extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        $this->execute('insert into realty_company(id, name, logo) values (1, "Alain Pinel", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (2, "Insignia Mortgage", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (3, "J. Rockcliff Mortgage", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (4, "John L Scott Mortgage", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (5, "Pacific Union", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (6, "Realogics Sotheby", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (7, "RealtyOne", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (8, "Redfin", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (9, "REMAX", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (10, "REMAX Estate", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (11, "Rockwell Realty", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        ...
        $this->execute('insert into realty_company(id, name, logo) values (13, "Skyline Properties", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (14, "Windermere Realty", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
        $this->execute('insert into realty_company(id, name, logo) values (15, "Windermere Realty Maple Valley", "https://s3.amazonaws.com/1rex.realty.logo/no-logo.png")');
