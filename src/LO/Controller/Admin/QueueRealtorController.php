...
class QueueRealtorController extends Base
{
    use GetFormErrors;
    ...
    /**
     * @param Application $app
     * @param QueueRealtor $model
     * @param Request $request
     * @return \Symfony\Component\Form\Form|\Symfony\Component\Form\FormInterface
     */
    private function createForm(Application $app, QueueRealtor $model, Request $request)
    {
    ...
    {
        $model = $app->getEntityManager()->getRepository(QueueRealtor::class)->find($id);
        if (!$model
            //|| $model->getDeleted() !== '0'
        ) {
